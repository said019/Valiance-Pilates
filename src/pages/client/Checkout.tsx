              ...
              {loadingPlans ? (
                ...
                <div className="space-y-6">
                  ...
                  {selectedPlan && comboTier && (
                    <div className="rounded-2xl border border-[#D9B5BA]/25 bg-[#D9B5BA]/[0.04] p-4 space-y-3">
                      <div className="flex items-center gap-2">
                        <Heart size={14} className="text-[#D9B5BA]" />
                      ...
                      <p className="text-[11px] text-[#1A1A1A]/60 -mt-1">
                        {classCount} clases + complemento: <strong className="text-[#1A1A1A]/80">${comboTier.price.toLocaleString("es-MX")}</strong>
                        {" "}
                        <span className="text-[#6B4F53] font-bold">(efectivo/transf: ${comboTier.discount.toLocaleString("es-MX")})</span>
                      </p>
                          ...
                          return (
                            <button
                              ...
                              className={cn(
                                ...
                                isSel
                                  ? "border-[#D9B5BA]/50 bg-[#D9B5BA]/10"
                                  : "border-[#8C6B6F]/10 bg-white/50 hover:border-[#8C6B6F]/20"
                              )}
                            >
                              {isSel ? (
                                <span className="w-5 h-5 rounded-full bg-gradient-to-br from-[#D9B5BA] to-[#8C6B6F] flex items-center justify-center shrink-0">
                                  <Check size={10} className="text-white" />
                                </span>
                              ) : (
                                <span className="w-5 h-5 rounded-full border border-[#8C6B6F]/20 shrink-0" />
                              )}
                              <div>
                                <p className="text-sm font-semibold text-[#1A1A1A]">{comp.name}</p>
                                <p className="text-xs text-[#8C6B6F]/60">{comp.specialist}</p>
                              </div>
                            </button>
                          );
                        })}
              ...
              {selectedPlan && (
                <div className="rounded-2xl border border-[#8C6B6F]/15 bg-[#8C6B6F]/[0.04] p-4 space-y-4">
                  <div className="text-xs text-[#1A1A1A]/60 space-y-1.5">
                    ...
                    {complementData && (
                      <p className="text-[#6B4F53] font-semibold">+ {complementData.name} ({complementData.specialist})</p>
                    )}
          ...
          {step === "method" && (
            <div className="space-y-4">
              ...
              <div className="rounded-2xl border border-[#8C6B6F]/20 bg-[#8C6B6F]/5 px-4 py-3">
                ...
                {complementData && (
                  <p className="text-xs text-[#6B4F53] font-semibold mt-1">+ {complementData.name}</p>
                )}
                {cashTransferPrice && cashTransferPrice < basePrice && (
